 ...
 * 
 * import com.hcl.fundtransfer.dto.FundTransferDto; import
 * com.hcl.fundtransfer.dto.PayeeDto; import
 * com.hcl.fundtransfer.service.TransectionService;
 * 
 *//**
 ...
 * 
 * @Validated public class TransectionController {
 * 
 * @Autowired private TransectionService transectionService;
 * 
 *//**
 ...
 *//**
	 ...
	 * @return
	 *//*
		 * @PostMapping("/fundtransfer") public ResponseEntity<?>
		 * fundTransfer(@Valid @RequestBody FundTransferDto fundTransfer){ try {
		 * transectionService.fundTransfer(fundTransfer); return new
		 * ResponseEntity<>("Transection Successful", HttpStatus.OK); }catch(Exception
		 * ex) { return new ResponseEntity<>(ex, HttpStatus.INTERNAL_SERVER_ERROR); } }
		 * }
		 */